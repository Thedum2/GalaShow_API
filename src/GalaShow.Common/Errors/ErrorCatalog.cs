...
namespace GalaShow.Common.Errors
{
    public static class ErrorCatalog
    {
        private static readonly ConcurrentDictionary<ErrorCode, ErrorInfo> Map = new()
        {
            ...
            [ErrorCode.SnsLinkNotFound]         = new(ErrorCode.SnsLinkNotFound, "SnsLink not found", 404),
            [ErrorCode.SnsLinkUpdateFailed]     = new(ErrorCode.SnsLinkUpdateFailed, "Failed to update SnsLink", 500),
        };
